...
function TeacherBusinessDay(props) {
  ...
  const onExport = () => {
    PermissionHelpers.ExportExcel({
      ...
      FuncApi: () =>
        reportsApi.getListTeacherBusinessDay(
          BrowserHelpers.getRequestParamsSchools(filters, {
            Total: PageTotal
          })
        ),
      UrlName: '/bao-cao/gv-cong-tac-phi-ngay'
    })
  }
      ...
      <div className="bg-white rounded">
        <div className="px-20px py-15px border-bottom border-gray-200 d-flex align-items-center justify-content-between">
          <div className="fw-500 font-size-lg">
            Danh sách Giáo viên - Công tác phí ngày
          </div>
        </div>
...
export default TeacherBusinessDay
